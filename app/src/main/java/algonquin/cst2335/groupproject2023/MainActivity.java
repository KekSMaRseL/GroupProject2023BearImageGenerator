package algonquin.cst2335.groupproject2023;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (width <= 0 || height <= 0) {
                    Toast.makeText(MainActivity.this, "Width and height must be positive numbers", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(MainActivity.this, "Image is being generated...", Toast.LENGTH_SHORT).show();
